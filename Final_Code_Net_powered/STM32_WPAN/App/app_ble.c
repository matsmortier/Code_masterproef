...
static char a_GapDeviceName[] = {  'S', '3' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[14] =
{
  3, AD_TYPE_SHORTENED_LOCAL_NAME , 'S', '3',  /* Shortened name */
  9, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x30, 0x00, 0x11 /* first 2 digit temp */, 0x11 /* last 2 digits temp */, 0x11 /* first 2 digits hum */, 0x11 /* last 2 digits hum */, 0x11 /* first 2 digits CO2 */, 0x11 /* last 2 digits CO2 */,
};
