...
../Core/RTT/SEGGER_RTT_Syscalls_GCC.c \
../Core/RTT/SEGGER_RTT_printf.c 

OBJS += \
./Core/RTT/SEGGER_RTT.o \
./Core/RTT/SEGGER_RTT_Syscalls_GCC.o \
./Core/RTT/SEGGER_RTT_printf.o 

C_DEPS += \
./Core/RTT/SEGGER_RTT.d \
./Core/RTT/SEGGER_RTT_Syscalls_GCC.d \
./Core/RTT/SEGGER_RTT_printf.d 


# Each subdirectory must supply rules for building sources it contributes
Core/RTT/%.o Core/RTT/%.su Core/RTT/%.cyclo: ../Core/RTT/%.c Core/RTT/subdir.mk
...
clean: clean-Core-2f-RTT

clean-Core-2f-RTT:
	-$(RM) ./Core/RTT/SEGGER_RTT.cyclo ./Core/RTT/SEGGER_RTT.d ./Core/RTT/SEGGER_RTT.o ./Core/RTT/SEGGER_RTT.su ./Core/RTT/SEGGER_RTT_Syscalls_GCC.cyclo ./Core/RTT/SEGGER_RTT_Syscalls_GCC.d ./Core/RTT/SEGGER_RTT_Syscalls_GCC.o ./Core/RTT/SEGGER_RTT_Syscalls_GCC.su ./Core/RTT/SEGGER_RTT_printf.cyclo ./Core/RTT/SEGGER_RTT_printf.d ./Core/RTT/SEGGER_RTT_printf.o ./Core/RTT/SEGGER_RTT_printf.su

.PHONY: clean-Core-2f-RTT
