...
SENSORSDATA_APP_ConnHandleNotEvt_t SENSORSDATAHandleNotification;

static char a_GapDeviceName[] = {  'S', '1' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[12] =
{
  3, AD_TYPE_SHORTENED_LOCAL_NAME , 'S', '2',  /* Shortened name */
  7, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x30, 0x00, 0x00 /* first 2 digit temp */, 0x00 /* last 2 digits temp */, 0x00 /* first 2 digits hum */, 0x00 /* last 2 digits hum */,
};
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      SENSORSDATAHandleNotification.EvtOpcode = SENSORSDATA_DISCON_HANDLE_EVT;
      SENSORSDATAHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      SENSORSDATA_APP_EvtRx(&SENSORSDATAHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SENSORSDATAHandleNotification.EvtOpcode = SENSORSDATA_CONN_HANDLE_EVT;
          SENSORSDATAHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          SENSORSDATA_APP_EvtRx(&SENSORSDATAHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SENSORSDATAHandleNotification.EvtOpcode = SENSORSDATA_CONN_HANDLE_EVT;
          SENSORSDATAHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          SENSORSDATA_APP_EvtRx(&SENSORSDATAHandleNotification);
